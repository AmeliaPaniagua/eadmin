...
public class ModeloBaseAdministracionElectronicaTest {
	...
	public void inicializarCadaTest() {
		documento = new ModeloBaseAdministracionElectronicaFake(CODIGO_DOCUMENTO, NOMBRE_DOCUMENTO, FECHA_CREACION);
	}
	...
	public void deberiaDevolverTrueSiTienenIgualCodigo() {
		...
		final ModeloBaseAdministracionElectronicaFake documento2 = new ModeloBaseAdministracionElectronicaFake (CODIGO_DOCUMENTO, NOMBRE_DOCUMENTO, FECHA_CREACION);
	...
	public void deberiaDevolverFalseSiNoTienenIgualCodigo() {
		...
		final ModeloBaseAdministracionElectronicaFake documento2 = new ModeloBaseAdministracionElectronicaFake (5, NOMBRE_DOCUMENTO, FECHA_CREACION);
