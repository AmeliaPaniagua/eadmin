...
public class DocumentoContableBuilder extends DocumentoBuilder{
	...
	public DocumentoContable construir() {
		...
		return new DocumentoContable(this.codigo, this.nombre, this.fechaCreacion, this.fechaUltimaActualizacion, this.publico, this.estado, this.importe, this.dniInteresado); 
